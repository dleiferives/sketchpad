...
The puck locks its axis after six logical pixels of movement. Size doubles per 100 logical pixels; opacity changes by 50 percentage points per 100 vertical pixels. Up increases opacity. Canvas adjustments retain ownership until release, even when the modifier is released first. Escape restores the initial canvas adjustment; cancelling a pen adjustment suppresses the remaining contact until lift.
